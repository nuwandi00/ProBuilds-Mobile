...
public final class FeedbackFragmentBinding implements ViewBinding {
  ...
  private FeedbackFragmentBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button editfdbtnupdate, @NonNull EditText editfeedbackComment,
      @NonNull EditText editfeedbackName, @NonNull ImageView fdimageView3,
  ...
  @NonNull
  public static FeedbackFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FeedbackFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.feedback_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FeedbackFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FeedbackFragmentBinding((ConstraintLayout) rootView, editfdbtnupdate,
          editfeedbackComment, editfeedbackName, fdimageView3, fdimageView6, fdimageView7,
          fdtextView36);
    }
