...
public abstract class Hilt_MedicineFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MedicineFragment_GeneratedInjector) this.generatedComponent()).injectMedicineFragment(UnsafeCasts.<MedicineFragment>unsafeCast(this));
    }
  }
