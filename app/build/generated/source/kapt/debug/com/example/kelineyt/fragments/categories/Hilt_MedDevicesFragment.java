...
public abstract class Hilt_MedDevicesFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MedDevicesFragment_GeneratedInjector) this.generatedComponent()).injectMedDevicesFragment(UnsafeCasts.<MedDevicesFragment>unsafeCast(this));
    }
  }
