...
public abstract class Hilt_NutritionFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NutritionFragment_GeneratedInjector) this.generatedComponent()).injectNutritionFragment(UnsafeCasts.<NutritionFragment>unsafeCast(this));
    }
  }
