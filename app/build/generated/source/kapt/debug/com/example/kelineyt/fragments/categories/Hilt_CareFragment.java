...
public abstract class Hilt_CareFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CareFragment_GeneratedInjector) this.generatedComponent()).injectCareFragment(UnsafeCasts.<CareFragment>unsafeCast(this));
    }
  }
