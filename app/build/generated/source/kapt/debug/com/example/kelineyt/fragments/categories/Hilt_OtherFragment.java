...
public abstract class Hilt_OtherFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OtherFragment_GeneratedInjector) this.generatedComponent()).injectOtherFragment(UnsafeCasts.<OtherFragment>unsafeCast(this));
    }
  }
